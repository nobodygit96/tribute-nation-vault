...
- **Dubbio di Vale sul 2026-08-25: "account pubblicitario sbagliato collegato a Instagram" — non confermato, ma ha portato a una correzione importante.** Controllato da più angolazioni: (1) Impostazioni business → Account Instagram: un solo account (`@_tribute_nation_`), unica risorsa collegata è la Pagina Facebook "TributeNation", nessun account pubblicitario elencato; (2) "Risorse collegate" di entrambi gli account pubblicitari: nessuno dei due mostra risorse collegate nel grafo asset del BM; (3) anteprima reale di tutte le inserzioni Instagram-native storiche su entrambi gli account (comprese quelle appena scoperte su `1548998116564966`): identità corretta ovunque, sempre `TributeNation`/`@_tribute_nation_`. Origine del dubbio, chiarita da Vale: provando a sponsorizzare dall'app Instagram, l'account offerto sembra "nuovo". Controllando `1548998116564966` per la prima volta in Gestione inserzioni (prima solo ipotizzato "mai usato" dalle impostazioni business, mai verificato) è emerso che **ha davvero avuto una campagna reale** (€47,28, conclusa il 09/08/2026) — quindi nessuno dei due account è genuinamente "nuovo". Resta aperta la domanda su quale dei due l'app Instagram offra oggi di default e perché possa sembrare "nuovo" a Vale: non verificabile da questa sessione desktop (serve controllare direttamente dall'app, annotando l'ID/nome esatto mostrato).
