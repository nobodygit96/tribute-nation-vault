...
- **CTA button: rimasta su "Vedi dettagli"** (default Meta, non "Registrati"/"Iscriviti" come inizialmente ipotizzato) — quella label esatta non esiste tra le opzioni Meta, e il menu si è rivelato un widget quasi impossibile da automatizzare in modo affidabile; "Vedi dettagli" è comunque una CTA reale e funzionante (verificata in anteprima), non un segnaposto vuoto. Non bloccante, si può cambiare a mano in un secondo momento se serve.
...
- **Impostata e pubblicata il 2026-09-05** ("Nuovo traffico band settembre", nome scelto da Vale). Procedura reale, incluso il blocco "campo link obbligatorio" su 11 posizionamenti e la sua causa vera (creatività di default non sostituita nei singoli gruppi di posizionamento, non la CTA), documentata in dettaglio nella skill [[meta-ads-campaign]] — da seguire per la prossima campagna invece di reindagare da zero. Stato subito dopo la pubblicazione: "In fase di elaborazione" (revisione Meta), importo speso €0,00.
- **Seconda campagna, non ancora impostata**: boost dell'ultimo post pubblicato, €4/giorno × 5 giorni, **solo Instagram** (vincolo esplicito di Vale). Da fare con la stessa skill [[meta-ads-campaign]], identificando prima quale sia "l'ultimo post pubblicato" al momento in cui si esegue.
