...
| F | Aggiungere un secondo admin umano stabile al portfolio (secondo la raccomandazione di Meta/Veronica Gentili su "almeno un admin di backup") | Medio (dà accesso completo a una seconda persona reale) | Sì, un admin si può rimuovere | Da valutare **solo se e quando Vale vuole** un backup reale (es. Daniele) — nessuna urgenza, oggi Vale è l'unica persona reale con accesso, il che è un punto di attenzione ma non un'emergenza |
